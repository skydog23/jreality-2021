 ...
 * 
 */
public abstract class TextSliderBad<T extends Number> extends JPanel  {
	...
	private TextSliderBad(String label, int orientation, T min, T max, T value, int sliderMin, int sliderMax, int sliderValue, 
	...
	public static class Integer extends TextSliderBad<java.lang.Integer>	{
	 ...
	 * 
	 */
	public static class Double extends TextSliderBad<java.lang.Double>	{
		private static final long serialVersionUID = 1L;
	 ...
	 * 
	 */
	public static class DoubleLog extends TextSliderBad.Double	{
		private static final long serialVersionUID = 1L;
	 ...
	 * 
	 */
	public static class IntegerLog extends TextSliderBad.DoubleLog	{
		private static final long serialVersionUID = 1L;
